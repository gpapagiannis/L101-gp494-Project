            ...
            for idx, l in enumerate(b):
                if l!=-1:
                    if results[k] != 0  and l==0:
                        ...
                        tporg+=1
                k+=1
#{'0': 'O', '1': 'I-ORG', '2': 'I-MISC', '3': 'I-PER', '4': 'I-LOC', '5': 'B-LOC', '6': 'B-MISC', '7': 'B-ORG'}
        if tporg > 0:
            p = (tporg/(tporg+fporg)); r = (tporg/(tporg+fnorg))

            print("O: Precision: ", p, " Recall: ", r, "F1: ", (2*p*r)/(p+r))
        ...
        for i, b in enumerate(batch_y):
            for idx, l in enumerate(b):
                if l!=-1:
                    if results[k] != 1 and results[k]!=7 and (l==1  or l==7):
                        fnorg+=1
                        
                    elif (results[k] ==1 or results[k] == 7) and l!=1 and l!=7:
                        fporg+=1
                    elif results[k] == 1 and l == 1:
                        tporg+=1
                    elif results[k] == 7 and l == 7:
                        tporg+=1
                k+=1
#{'0': 'O', '1': 'I-ORG', '2': 'I-MISC', '3': 'I-PER', '4': 'I-LOC', '5': 'B-LOC', '6': 'B-MISC', '7': 'B-ORG'}
        if tporg > 0:
            p = (tporg/(tporg+fporg)); r = (tporg/(tporg+fnorg))
            print("ORG: Precision: ", p, " Recall: ", r, "F1: ", (2*p*r)/(p+r))
...
#{'0': 'O', '1': 'I-ORG', '2': 'I-MISC', '3': 'I-PER', '4': 'I-LOC', '5': 'B-LOC', '6': 'B-MISC', '7': 'B-ORG'}
        if tporg > 0:
            ...
            print("PER: Precision: ", p, " Recall: ", r, "F1: ", (2*p*r)/(p+r))
        ...
        for i, b in enumerate(batch_y):
            for idx, l in enumerate(b):
                if l!=-1:
                    if results[k] != 2 and results[k]!=6 and (l==2  or l==6):
                        fnorg+=1
                        
                    elif (results[k] ==2 or results[k] == 6) and l!=2 and l!=6:
                        fporg+=1
                    elif results[k] == 2 and l == 2:
                        tporg+=1
                    elif results[k] == 2 and l == 6:
                        tporg+=1
                k+=1
#{'0': 'O', '1': 'I-ORG', '2': 'I-MISC', '3': 'I-PER', '4': 'I-LOC', '5': 'B-LOC', '6': 'B-MISC', '7': 'B-ORG'}
        if tporg > 0:
            p = (tporg/(tporg+fporg)); r = (tporg/(tporg+fnorg))
            print("MISC: Precision: ", p, " Recall: ", r, "F1: ", (2*p*r)/(p+r))
        ...
        for i, b in enumerate(batch_y):
            for idx, l in enumerate(b):
                if l!=-1:
                    if results[k] != 4 and results[k]!=5 and (l==4  or l==5):
                        fnorg+=1
                        
                    elif (results[k] ==4 or results[k] == 5) and l!=4 and l!=5:
                        fporg+=1
                    elif results[k] == 4 and l == 4:
                        tporg+=1
                    elif results[k] == 5 and l == 5:
                        tporg+=1
                k+=1
#{'0': 'O', '1': 'I-ORG', '2': 'I-MISC', '3': 'I-PER', '4': 'I-LOC', '5': 'B-LOC', '6': 'B-MISC', '7': 'B-ORG'}
        if tporg > 0:
            p = (tporg/(tporg+fporg)); r = (tporg/(tporg+fnorg))
            print("LOC: Precision: ", p, " Recall: ", r, "F1: ", (2*p*r)/(p+r))
...
def main():
    ...
    for i in range(1):
        print("------------",i)
#        lstm_net.load_state_dict(torch.load("standard_lstm_seed_{}.pt".format(i), map_location=torch.device('cpu')))
        losses = []
...
#            torch.save(lstm_net.state_dict(), "standard_lstm_seed_{}.pt".format(seed))
#            joblib.dump(losses, "losses_stand_lstm_{}.pkl".format(seed))
#
#
